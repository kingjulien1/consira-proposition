      ...
      >
        {loopItems.map(({ label, icon: Icon }, index) => (
          ...
          >
            ...
            <span className="relative flex h-5.5 w-5.5 items-center justify-center rounded-full border border-black/[0.045] bg-[#f7f5ef]/55 text-black shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] transition duration-300 group-hover:border-[#7664BD]/25 group-hover:bg-[#7664BD] group-hover:text-white group-hover:shadow-[0_10px_24px_rgba(118,100,189,0.26)]">
