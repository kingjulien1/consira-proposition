...
function ResearchPremiumSection() {
  return (
    <section
      ...
      className="relative z-10 min-h-screen overflow-hidden rounded-t-[3rem]"
    >
      <SectionFadeBackground start={0.14} end={0.46} />
      <div className="relative flex min-h-screen overflow-hidden px-6 pb-24 pt-10 text-white sm:px-10 lg:px-14 lg:py-12">
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <SideHeadingMotion className="max-w-2xl">
            <ScrollReveal>
              <SectionBadge icon="euro" tone="dark">
          ...
          <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="grid gap-4">
              {premiumFacts.map(({ icon: Icon, title, text }, index) => (
                ...
                >
                  <SpotlightCard className="relative rounded-[1.5rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.065),rgba(255,255,255,0.028)_48%,rgba(255,255,255,0.012))] p-5 transition hover:border-white/20 hover:bg-white/[0.06]">
            ...
            <ScrollReveal delay={0.32} className="relative z-20 min-h-80">
              <SpotlightCard className="flex h-full min-h-80 flex-col justify-between rounded-[1.5rem] border border-white/80 bg-[#f7f5ef] p-6 text-[#080709] shadow-[0_25px_80px_rgba(0,0,0,0.2)]">
      ...
      <div className="relative flex min-h-screen flex-col overflow-visible bg-[#f7f5ef] px-6 text-[#080709] sm:px-10 lg:px-14">
        ...
        <div className="relative flex flex-1 items-center pb-24 pt-10 lg:py-12">
          <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 lg:grid-cols-[0.86fr_1.14fr]">
            <SideHeadingMotion className="max-w-2xl">
              <ScrollReveal>
                <SectionBadge icon="compass" tone="light">
                  Für Wen?
                </SectionBadge>
                <TypewriterHeading
