    ...
    <>
      {stories.map(({ icon: Icon, value, valueClassName, title, text }, index) => (
        <ScrollReveal
          ...
          disableBlur
        >
          <div className={`${cardClassName} border-glow-card success-gold-card group/story relative overflow-hidden !border-transparent p-2.5 shadow-[0_18px_70px_rgba(0,0,0,0.28)] transition duration-500 hover:-translate-y-1 sm:p-3 lg:h-[13.25rem] lg:rounded-[1.65rem]`}>
